...
public class ZHashSetTest {
  private HashSet<Integer> emptySet;
  private HashSet<Integer> singletonSet;
  private HashSet<Integer> s1;
  private HashSet<Integer> s2;
  private HashSet<Integer> s3;
  

  @Before
  public void setUp() throws Exception {
    emptySet = new HashSet<>();
    singletonSet = new HashSet<>();
  ...
  public void testConstructors() {
    HashSet<Integer> s = new HashSet<>(0);
    assertEquals(Hashtable.DEFAULT_SIZE, s.tableSize());
    s = new HashSet<>(120);
    assertEquals(127, s.tableSize());
  }
